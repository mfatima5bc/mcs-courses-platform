...
import { Enrollment } from "@/graphql/generated/graphql";
                        ...
                        <div className="truncate">
                          ...
                          <div className="mt-2 flex">
                            <div className="flex items-center text-sm text-gray-500">
                              ...
                              <p>
                                Turma inicia em <time dateTime={String(enrollment.createdAt)}>
                                  {dateFormatter.format(new Date(String(enrollment.createdAt)))}
                                </time>
                              </p>
                            </div>
                          </div>
